...
👉 1.1 Below the **Action call**, click on the **`+`** button and choose **Send Response → Send Message**.  

   <img width="940" height="461" alt="image" src="https://github.com/user-attachments/assets/297092e9-0f24-493a-8048-090cf9c1b817" />


👉 1.2 On the right panel, change the step name to **Simulate Workload Message** and **Save**.


👉 1.3 Click on **Open Message Editor**.  
...
👉 2.4 In the **Title** field, click **`<>`** and map  
...
👉 2.5 In the **Text** field, click **`<>`** and map  
...
👉 2.6 In the **Status** field, click **`<>`** and map  
...
👉 2.6 In the **Detail View > Section Details**, set **Title:** `Optimization Details`
...
👉 3.1 In the **Attributes** section, click **Add Attribute** and create the following:  
